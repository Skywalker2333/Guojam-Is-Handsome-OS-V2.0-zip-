...
set "frpcPath=C:\gj\guojam\is\handsome\2.0\Guojam-Is-Handsome-OS-V2.0-zip--5\frpc.exe"
set "configFile=C:\gj\guojam\is\handsome\2.0\Guojam-Is-Handsome-OS-V2.0-zip--5\frpc.ini"
